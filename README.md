...
Aceasta este o aplicatie dezvoltata in C# destinata instructorilor care sustin cursuri saptamanale pentru copii. Rolul aplicatiei este de a tine evidenta prezentelor si de a monitoriza automat statusul platilor pentru fiecare cursant.

---

**Operatii pe care doresc sa le implementez:**

* **1. Adaugarea cursantilor:** Inregistrarea copiilor in sistem cu un nume si un sold initial de sedinte platite.
